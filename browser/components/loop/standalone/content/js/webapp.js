    ...
    render: function() {
      ...
      return (
        ...
        React.DOM.header({className: "container-box"}, 
          ...
          React.DOM.div({className: "loop-logo", title: "Loop logo", 
            src: ""}), 
          React.DOM.h3({className: "call-url"}, 
            conversationUrl
          ), 
          React.DOM.h4({className: "light-color-font call-url-date"}, 
    ...
    render: function() {
      return (
        React.DOM.div(null, 
          ...
          React.DOM.p({className: "footer-external-links"}, 
            React.DOM.a({href: "#"}, "Mozilla 2014"), 
            React.DOM.a({href: "#"}, "Privacy Policy"), 
            React.DOM.a({href: "#"}, "Get Help")
          )
        )
      );
    }
